  ...
  $.getJSON(url, function(data) {
    ...
    $(deals).each(function(i){
      ...
      if(this[7]){
        ...
        offerSection.prepend('<div class="col"><div class="offer"><a class="offer__link" href="'+saleURL+'"><span class="btn btn--orange">View Offer</span></a><div class="bg-img bg-img--3-2" style="background-image: url('+saleImage+')"></div><div class="offer__content"><h3 class="title title--xs">'+saleTitle+'</h3><h4 class="offer__location">'+saleLocation+'</h4><div class="offer__description">'+saleDescription+'</div><div class="offer__bottom"><div class="offer__bottom-left"><div class="offer__saved"><div class="offer__saved-label">Save up to&nbsp;</div><div class="offer__saved-percent">'+saleDiscount+'%</div></div><div class="offer__separator"></div><div class="offer__details"><div>From <span class="offer__price">'+salePrice+'</span></div><div class="text--sm">'+salePriceDescription+'</div></div></div><div class="offer__bottom-right"><div class="offer__arrow"></div></div></div></div></div></div>');
      }// end if
